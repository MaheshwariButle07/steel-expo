...
function Page() {
  ...
  const [phoneValidation, setPhoneValadation] = useState(true);
  ...
  const handleIsWhatsappChange = (selectOption) => {
    const is_whatsapp = selectOption.value;
  ...
  const handleCountryChange = (selectOption) => {
    setFormData({
      ...formData,
  ...
  const handleCategoryChange = (selectOption) => {
    setFormData({
      ...formData,
  ...
  const handelSubmit = async (e) => {
    ...
    if (password !== confirm_password) {
      toast.error("Password do not match . Please check the Password",
         {
          position: "top-center",
          autoClose: 3000,
    ...
    try {
      ...
      if (inserError) throw Error(inserError.message);

      await axios.post("http://localhost:4000/send_email_exhibitor",
      {
        participant_name,
          email,
          phone_number,
      ...
      toast.success("succesfull Registerd",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
    ...
    <div className="px-4 sm:px-6">
      ...
      <div className="m-5 border rounded-md p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-5">
          ...
          <div>
            <Label htmlFor="company_website" className="text-lg font-bold">
              Company Website
            </Label>
            <Input
              id="company_website"
          ...
          <div>
            <Label htmlFor="address_line_one" className="text-lg font-bold">
              Address Line
            </Label>
            <Input
              id="address_line_one"
          ...
          <div>
            <Label htmlFor="address_line_two" className="text-lg font-bold">
              Address Line 2
            </Label>
            <Input
              id="address_line_two"
          ...
          <div>
            <Label htmlFor="pincode" className="text-lg font-bold">
              Pincode
            </Label>
            <Input
              id="pincode"
